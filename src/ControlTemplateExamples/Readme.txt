The source code for the ControlTemplateExamples project was originally derived from the "Styling with ControlTemplates Sample" which can be found here:

http://archive.msdn.microsoft.com/wpfsamples

Download
http://archive.msdn.microsoft.com/Project/Download/FileDownload.aspx?ProjectName=wpfsamples&DownloadId=7741
