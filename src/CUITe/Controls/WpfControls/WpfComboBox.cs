...
namespace CUITe.Controls.WpfControls
{
    ...
    {
        public WpfComboBox(CUITControls.WpfComboBox sourceControl = null, string searchProperties = null)
            : base(sourceControl ?? new CUITControls.WpfComboBox(), searchProperties)
        {
        }
