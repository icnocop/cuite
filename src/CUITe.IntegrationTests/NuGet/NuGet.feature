...
Scenario Outline: Adding the CUITe NuGet package to a Coded UI test project
	...
	And the CUITe nuget package "<NuGetPackageId>" is added to the project
	...
	Examples:
	| Description                                                   | VisualStudioVersion | TargetFrameworkVersion | NuGetPackageId           |
	| Visual Studio 2010 and .NET Framework 4.0                     | 2010                | 4.0                    | CUITe.VS2010             |
	| Visual Studio 2010 and Silverlight 5                          | 2010                | 4.0                    | CUITe.Silverlight.VS2010 |
	| Visual Studio 2012 and .NET Framework 4                       | 2012                | 4.0                    | CUITe.VS2012             |
	| Visual Studio 2012 and .NET Framework 4.5                     | 2012                | 4.5                    | CUITe.VS2012             |
	| Visual Studio 2012 and .NET Framework 4.5.1                   | 2012                | 4.5.1                  | CUITe.VS2012             |
	| Visual Studio 2012 and .NET Framework 4.5.2                   | 2012                | 4.5.2                  | CUITe.VS2012             |
	| Visual Studio 2012 and .NET Framework 4.6                     | 2012                | 4.6                    | CUITe.VS2012             |
	| Visual Studio 2012 and .NET Framework 4 and Silverlight 5     | 2012                | 4.0                    | CUITe.Silverlight.VS2012 |
	| Visual Studio 2012 and .NET Framework 4.5 and Silverlight 5   | 2012                | 4.5                    | CUITe.Silverlight.VS2012 |
	| Visual Studio 2012 and .NET Framework 4.5.1 and Silverlight 5 | 2012                | 4.5.1                  | CUITe.Silverlight.VS2012 |
	| Visual Studio 2012 and .NET Framework 4.5.2 and Silverlight 5 | 2012                | 4.5.2                  | CUITe.Silverlight.VS2012 |
	| Visual Studio 2012 and .NET Framework 4.6 and Silverlight 5   | 2012                | 4.6                    | CUITe.Silverlight.VS2012 |
	| Visual Studio 2013 and .NET Framework 4                       | 2013                | 4.0                    | CUITe.VS2013             |
	| Visual Studio 2013 and .NET Framework 4.5                     | 2013                | 4.5                    | CUITe.VS2013             |
