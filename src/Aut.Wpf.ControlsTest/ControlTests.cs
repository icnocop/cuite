using System.IO;
using Aut.Wpf.ControlsTest.ScreenObjects;
using Microsoft.VisualStudio.TestTools.UITesting;
using Microsoft.VisualStudio.TestTools.UnitTesting;

namespace Aut.Wpf.ControlsTest
{
    [CodedUITest]
#if DEBUG
    [DeploymentItem(@"..\..\..\Aut.Wpf.Controls\bin\Debug")]
#else
    [DeploymentItem(@"..\..\..\Aut.Wpf.Controls\bin\Release")]
#endif
    public class ControlTests
    {
        private const string ApplicationFileName = "Aut.Wpf.Controls.exe";
